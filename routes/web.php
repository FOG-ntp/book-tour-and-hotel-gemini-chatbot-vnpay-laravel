...
Route::group(['namespace' => 'Page'], function() {
    ...
    Route::post('book/tourvnpay/{id}','TourController@postBookTourVNPay')->name('post.book.tour.vnpay');

    Route::get('/{id}/thanhtoan.html','TourController@getFromPayMent')->name('get.from.payment');
    Route::post('/post/payment','TourController@createPayMent')->name('post.payment');
    Route::get('vnpay/return','TourController@vnPayReturn')->name('vnpay.return');
